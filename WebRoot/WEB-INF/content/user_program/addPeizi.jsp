...
<div class="hqhpz">
<form id="programForm">
  <div class="hqhtop" style="padding: 40px 30px;height:540px;">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      ...
      <tr>
        ...
        <td>
	        ...
	        <div class="addPeiziHid" style="position: relative; top: 40px; left: -205px;color: red;font-size:14px;">只可以投资股指期货</div>
        </td>
      </tr>
      <tr>
        <th>方案类型：</th>
      ...
      <tr id="rpTR">
        ...
        <td>
	        ...
	        <input name="cycleNum1" id="cycleNum1" type="text" class="qhzjbl qhzjblk"  onkeyup="changeCycle1(this.value);" onafterpaste="this.value=this.value.replace(/\D/g,'')" value="1"/>
      ...
      <tr id="ypTR">
        ...
        <td>
	        ...
	        <input name="cycleNum2" id="cycleNum2" type="text" class="qhzjbl qhzjblk" onkeyup="changeCycle2(this.value);" onafterpaste="this.value=this.value.replace(/\D/g,'')" value="1"/>
    ...
    <div class="jyed">
    	<div id="dianjuan">
	    	...
	    	<input id="point" type="text" class="jeye" onkeyup="changeIntegral(this.value)"/><span>*100</span>
    	</div>
  ...
  <div class="hqhbottom">
    ...
    <div id="ljpz" class="hqhbljpz">
       <a href="javascript:void(0);" onclick="stepProgram();">下一步</a>
    </div>
    <div class="ty">
...
function stepProgram(){
	...
	$.post("${ctx}/user_program/addProgramAjax.htm",data,function(d){
		...
		location.href="${ctx}/user_program/addProgramAjax.htm?matchMoney="+matchMoney+"&num="+num+"&programType="+programType+"&tradeTimeType="+tradeTimeType+"&cycleNum1="+cycleNum1+"&cycleNum2="+cycleNum2+"&integral="+integral;
	});
}
</script>