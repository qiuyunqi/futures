		...
		<div class="containImg">
			<div class="infoList">
		        ...
		        <form action="" method="post">
					...
					<a class="fullAstyYqb" onclick="saveGiveTicket()">提交</a>
		        </form>
		        </div>
			</div>
		</div>
...
function saveGiveTicket() {
		...
		if (check()) {
			 $.post("${ctx}/wxyqb/saveGiveTicket.htm", {serverId: serverId, openEquity: openEquity, salesDept: salesDept, accountType: accountType, message: message, publishUserId: "${publishUserId}",userId:"${userId}",
					profitModel: profitModel, availableSplit: availableSplit, capitalAccount: capitalAccount}, function(data){
						...
						if (data == 8) {
							location.href="${ctx}/wxyqb/giveTicketSuccess.htm";
						}
			});
		} 
	}
