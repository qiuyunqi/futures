...
.vs{position: absolute;top:0;z-index:99;margin-left: -0.2rem;left: 50%;margin-top:-0.2rem;width：}
...
<body>
	 <div class="app-wrapper" id="wrapper">
		...
		<a id="a_more" class="moreInfo" onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'zhifubao_more'])" href="${ctx}/user_options/wqqInfoUp.htm">查看更多详情</a> 
		<div id="scrollobj" class="qimo8">
            ...
            <div class="app-img onepage" >
            	<div class="jindu">
	            	...
	            	<a class="appTxt redtxt" id="appTxt" onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'zhifubao_zhang'])" href="${ctx}/user_options/wqqPay.htm?guessType=1"><span id="redz" class="buy"><img src="../images_czt/maiBtnRed.png"/></span><span id="redSy" class="sy">最大收益170%</span></a>
	                <a class="appTxt appTxts" id="appTxts" onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'zhifubao_die'])" href="${ctx}/user_options/wqqPay.htm?guessType=0"><span id="greenD" class="buy"><img src="../images_czt/maiBtn.png"/></span><span id="greenSy" class="sy">最大收益110%</span></a>
            	</div> 
            	<div class="clear"></div>
            </div>
            <div class="daojis">
