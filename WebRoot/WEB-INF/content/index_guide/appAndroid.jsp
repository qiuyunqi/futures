...
<title>${title}－App下载（Android）</title>
...
<body>
	<div class="app-wrapper">
		<div class="app-content">
			...
			<div class="aapbtn">
			<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.hhr360.partner"><img src="../images_hhr/a-1.png" class="appimge"/></a>
			<span class="beizhu">通过微信扫描的页面，请在浏览器中打开并点击下载。</span>
			</div>
