...
<title>${title}－付款单据查询－安全配资服务平台</title>
...
<div class="content">
    <div class=" rt_cont">
    	...
    	<div class="rt_cont_title">
    	  ...
    	  <div class="form">
	            <form id="searchForm" action="${ctx}/finance_payment/paymentQuery.htm" method="post">
						  ...
						  <tr>
						    ...
						    <td>
						    	<div class="form_cont">
						            ...
						            <div class="fl"><a href="javascript:void(0);" onclick="queryPayment();" class="search">查询</a><a href="${ctx}/finance_payment/paymentQuery.htm" class="remove" style="margin-left:30px;">清空</a></div>
						            <div class="clr"></div>
						        </div>
						    </td>
						  </tr>
          ...
          <div class=" yhlb_title">付款明细记录</div>
            <div class="yhlb">
            	 <table width="100%">
				  <tbody>
				  <tr>
				  ...
				  <c:forEach items="${detailList}" var="detail" varStatus="row">
					  <tr style="cursor:pointer;" onmouseover="$(this).attr('bgcolor','#f6f6f6');" onmouseout="$(this).attr('bgcolor','');" >
					    ...
					    <td style="text-align:center"><div class=" caozuo">
						    <domi:privilege url="/finance_payment/exportExcel.htm"><a href="${ctx}/finance_payment/exportExcel.htm?id=${detail.id}">导出Excel</a></domi:privilege>
					    </td>
					  </tr>
				  </c:forEach>
				</tbody>
		  ...
		  <div class="page">
			<domi:pagination ctx="${ctx}" pageVolume="${pageSize}"
				url="${ctx}/finance_payment/paymentQuery.htm?totalCount=${totalCount}"
