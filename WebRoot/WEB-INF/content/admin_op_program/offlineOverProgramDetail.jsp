...
<div class="content">
    <div class=" rt_cont">
    	<div class="rt_cont_mat">
    	    <div class="rt_cont_title">线下结算方案详情<a href="${ctx}/admin_list_over_program/offlineOverProgramList.htm" class="fr add">返回</a></div>
         ...
         <div class="yhlb_title">结算出金明细记录</div>
           <div class="yhlb">
           	 <table width="100%">
			  <tbody>
			  <tr>
			  ...
			  <c:forEach items="${detailList}" var="detail" varStatus="row">
			  		<tr style="cursor: pointer;" onmouseover="$(this).css('background','#f6f6f6');" onmouseout="$(this).css('background','');">
					    ...
					    <td style="color:#137490" onclick="searchInfoByUser('${detail.fuUser.accountName}');">${detail.fuUser.accountName}</td>
					    <td style="color:#137490">${detail.fuProgram.id}</td>
					    <td style="color:#137490">${detail.fuProgram.fuServer.id}_${detail.fuProgram.tradeAccount}</td>
					    ...
					    <td><a href="${ctx}/admin_list_money_program/exportExcel.htm?id=${detail.id}">导出excel</a></td>
					 </tr>
			  </c:forEach>
    ...
    <div class=" bottom">
	    <a href="${ctx}/admin_list_over_program/offlineOverProgramList.htm" class="exit fr">关闭</a>
	    <div class="clr"></div>
    </div>
</div>
</body>
