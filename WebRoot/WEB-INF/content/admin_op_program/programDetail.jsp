...
<div class="content">
    <div class=" rt_cont">
    	<div class="rt_cont_mat">
    	    <div class="rt_cont_title">待审核方案详情<a href="${ctx}/admin_list_program/waitProgramList.htm" class="fr add">返回</a></div>
    ...
    <div class=" bottom">
	    <a href="${ctx}/admin_list_program/waitProgramList.htm" class="exit fr">关闭</a>
	    <c:if test="${program.status==2}">
	    <a href="javascript:void(0);" onclick="tellOpenProgram(${program.id});" class="exit fr">告知开户</a>
	    </c:if>
	    <c:if test="${program.status==0}">
		    <a href="javascript:void(0);" onclick="opProgram(3);" class="exit fr">开户失败</a>
		    <a href="javascript:void(0);" onclick="opProgram(2);" class="exit fr">方案开户</a>
	    </c:if>
