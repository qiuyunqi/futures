...
<div class="content">
    <div class=" rt_cont">
    	<div class="rt_cont_mat">
    	    <div class="rt_cont_title">结算方案详情<a href="${ctx}/admin_list_over_program/overProgramList.htm" class="fr add">返回</a></div>
    ...
    <div class=" bottom">
	    <a href="${ctx}/admin_list_over_program/overProgramList.htm" class="exit fr">关闭</a>
	    <div class="clr"></div>
    </div>
</div>
</body>
