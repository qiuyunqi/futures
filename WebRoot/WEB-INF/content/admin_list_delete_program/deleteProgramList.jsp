...
<div class="content">
    <div class=" rt_cont">
    	<div class="rt_cont_mat">
    	    <div class="rt_cont_title">已删除方案管理</div>
            <div class="form">
            <form id="searchForm" action="${ctx}/admin_list_delete_program/deleteProgramList.htm" method="post">
				  ...
				  <tr>
				    ...
				    <td>
				        <div class="form_cont">
				            ...
				            <div class="fl"><a href="javascript:void(0);" class="search" onclick="searchInfo();">搜索</a><a href="${ctx}/admin_list_delete_program/deleteProgramList.htm" class="remove" style="margin-left:30px;">清空</a></div>
				            <div class="clr"></div>
				        </div>
				    </td>
				  </tr>
          ...
          <div class=" yhlb_title">已删除方案列表</div>
            <div class="yhlb">
            	 <table width="100%">
				  <tbody><tr>
				    <th>&nbsp;</th>
				    ...
				    <th style=" text-align:center">查看详情</th>
					  ...
					  <s:iterator value="programList" var="program" status="row">
						    ...
						    <td style="color:#137490" onclick="window.location='${ctx}/admin_op_program/deleteProgramDetail.htm?id=${program.id}'">${program.id}</td>
						    ...
						    <td><fmt:formatNumber value="${empty program.manageMoney?0:program.manageMoney}" pattern="#,###,##0.00"/></td>
						  	...
						  	<td><fmt:formatDate value="${program.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						  	<td style="text-align:center"><div class="caozuo"><a href="${ctx}/admin_op_program/deleteProgramDetail.htm?id=${id}">查看详情</a></div></td>
						  </tr>
					  </s:iterator>
           ...
           <div class="page">
				<domi:pagination ctx="${ctx}" pageVolume="${pageSize}" url="${ctx}/admin_list_delete_program/deleteProgramList.htm?totalCount=${totalCount}" totalNum="${totalCount}" curPageNum="${pageNo}" formId="pageForm" >
