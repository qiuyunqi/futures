 ...
 * @author 弘威
 */
public interface FuStockAccountDao extends BaseDao<FuStockAccount, Long> {
...
//	 * @param examineStatus	账号的审核状态 0:审核中  1:审核成功 2:审核失败 
	 ...
	 * @return
	 */
	public List<FuStockAccount> findByStatus(int stexamineStatusate, int isDel);
	 ...
	 * @return
	 */
	public List<FuStockAccount> findAll(int isDel, int examin, int start,
			int pageSize);
