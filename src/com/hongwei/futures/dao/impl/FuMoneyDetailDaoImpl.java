 ...
 */
@Repository
public class FuMoneyDetailDaoImpl extends BaseDaoImpl<FuMoneyDetail, Long> implements FuMoneyDetailDao {
	...
	public BigDecimal getCountMoneyByDictionaryIdAndUserId(Long userId,
		...
		String sql = "SELECT SUM(money) FROM fu_money_detail, sys_dictionary  "
				+ "WHERE user_id = :userId AND fu_money_detail.dictionary_id = :dictionaryId  and "
