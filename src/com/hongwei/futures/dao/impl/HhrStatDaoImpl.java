...
public class HhrStatDaoImpl extends BaseDaoImpl<HhrStat, Long> implements HhrStatDao {

	@Override
	public Object[] findStatDataByMap(Map<String, Object> map) {
		String sql="select hhr_level,firstly_partner_num,secondary_partner_num," +
				   "extend_person_new,interest_return_coefficient,charges_return_coefficient,daily_income,monthly_income,total_income from hhr_stat h where 1=1 ";
