...
public class PaginationTag extends BodyTagSupport {
	private static final long serialVersionUID = -131909544696991989L;
	...
	public int doEndTag() throws JspException {
		ApplicationContext content = WebApplicationContextUtils
		...
		try {
			...
			int totalPageNum = ((totalNum % pageVolume) == 0 ? (totalNum / pageVolume)
					: (totalNum / pageVolume + 1));
			...
			freeMarkerConfigurer = (FreeMarkerConfigurer) content
					.getBean("freeMarkerConfigurer");
			Template temp = freeMarkerConfigurer.getConfiguration().getTemplate(
					templateFile);
