package com.hongwei.futures.web.action.finance_payment;
...
public class FinancePaymentAction extends BaseAction {
	...
	public String exportExcel() {
		try {
			...
			wc = ExcelUtil.cloneCellWithValue(2, 7, moneyDetail.getFuUser()
					.getUserName() == null ? "" : moneyDetail.getFuUser()
					.getUserName(), wcf6);
			ws.addCell(wc);
			...
			wc = ExcelUtil.cloneCellWithValue(2, 8,
