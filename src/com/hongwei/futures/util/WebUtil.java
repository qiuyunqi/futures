...
public class WebUtil {
	...
	public static String returnCode(ActionInvocation arg0,String code) throws Exception{
	 ...
	 * @param maxAge cookie存放的时间(以秒为单位,假如存放三天,即3*24*60*60; 如果值<=0,cookie将随浏览器关闭而清除)
	 */
