...
public class DateUtil {
	 ...
	 * @throws Exception
	 */
	public static String changeTime(Date time, String format, int days) throws Exception{
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(DateUtil.getDateFromString(DateUtil.getStrFromDate(null == time ? new Date() : time, format), format));
