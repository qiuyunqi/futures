...
public class WebContent {
	...
	public String getOneHtml(final String htmlurl) throws IOException{
		...
		//try {
	        ...
	        urlconn.getContent();
			PageEncodeDetector pageEncodeDetector = new PageEncodeDetector();
			String charset = pageEncodeDetector.getCharset(htmlurl);
	...
	public static String getContent(String link,String charset) throws Exception{
	...
	public static String getContentByPost(String link,String charset) throws Exception{
		URL url = new URL(link);
		URLConnection urlconn = url.openConnection();  
        HttpURLConnection httpConnection = (HttpURLConnection) urlconn;  
        httpConnection.setConnectTimeout(120000);
