...
public class CommonUtil {
	...
	public static String createFileTempName(int userId) {
		...
		fileName.append(nowTime).append("_").append(userId).append("_").append(
				random);
	...
	public static String createFileNoticeName(int userId, int orgId) {
		...
		String nowTime = DateUtil.getStrFromDate(new Date(), "yyyyMMddHHmmss"); // 当前时间
		int random = new Random().nextInt(999999); // 100W内的一个随机数
		fileName.append(nowTime).append("_").append(orgId).append("_").append(
				userId).append("_").append(random);
		return fileName.toString();
	}
	...
	public static String createFileLetterName(int sendUserId, int receiveUserId) {
		...
		String nowTime = DateUtil.getStrFromDate(new Date(), "yyyyMMddHHmmss"); // 当前时间
		int random = new Random().nextInt(999999); // 100W内的一个随机数
		fileName.append(nowTime).append("_").append(sendUserId).append("_")
				.append(receiveUserId).append("_").append(random);
		return fileName.toString();
	}
	...
	public static String getErweima(String link) {
		try {
			Map<String, String> map = new HashMap<String, String>();
			map.put("data", link);
			map.put("do_text", "1");
			Document doc = Jsoup.connect("http://qr.jibaoku.com/creat.php")
					.data(map).post();
	...
	public static String SMS(String postData, String postUrl) {
		try {
			postData = "sname=dlydswcf&spwd=XazE9m9Q&scorpid=&sprdid=1012818&sdst="
					+ postUrl + "&smsg=" + URLEncoder.encode(postData, "utf-8");
			// 发送POST请求
			URL url = new URL(
	 ...
	 * @throws Exception
	 */
	public static boolean sendSms1(String phones, String[] args) {
		HashMap<String, Object> result = null;

		CCPRestSDK restAPI = new CCPRestSDK();
		restAPI.init("app.cloopen.com", "8883");// 初始化服务器地址和端口，格式如下，服务器地址不需要写https://
		restAPI.setAccount("aaf98f8945df8c980145dfad47420019",
				"d61efeb4f3914998aed367a0a8769695");// 初始化主帐号名称和主帐号令牌
		restAPI.setAppId("aaf98fda45df8fde0145dfbea6fe0027");// 初始化应用ID
		result = restAPI.sendTemplateSMS(phones, "2858", args);
	...
	public static boolean sendSms_old(String phones, String[] args) {
		String msg=HttpClientUtil.postHTTP("http://service.winic.org/sys_port/gateway/?",
				"whkzdd", "1qaz2wsx", phones,
				"【超级合伙人】你的验证码是"+args[0]+",为了保护您的账号安全，验证短信请勿转发给其他人", "");
...
//		String content="【超级合伙人联盟】"+message;
	...
	/*public static boolean sendSms(String phones, String[] args) {
		String uri = "http://222.73.117.158/msg/main.do";//应用地址
		String account = "kunzhou_pc";//账号
		String pswd = "kzDD_2015";//密码
//		String account = "vip_cjhhr";//账号
//		String pswd = "Tch123456";//密码
//		String mobiles = "13800210021,13800138000";//手机号码，多个号码使用","分割
//		String content = "【坤州大德】你的验证码是"+args[0]+",为了保护您的账号安全，验证短信请勿转发给其他人";//短信内容
		String content = "你的验证码是"+args[0]+",为了保护您的账号安全，验证短信请勿转发给其他人";//短信内容
		...
		String str = "";
		try {
			String returnString = HttpSender.batchSend(uri, account, pswd, phones, content, needstatus, product, extno);
			System.out.println(returnString);
			str=returnString.split(",")[1];
...
//		String content = "【坤州大德】你的验证码是"+args[0]+",为了保护您的账号安全，验证短信请勿转发给其他人";//短信内容
	 ...
	 * @return
	 */
	public static boolean sendSms(String phone, String[] args) {
		String apikey = "190285e774686294dddc3de3286e812d";
		String str="";
		String message="【超级合伙人】您的验证码是"+args[0]+",为了保护您的账号安全，验证短信请勿转发给其他人。";
		try {
			String returnString=SendMessageUtil.sendSms(apikey, message, phone);
			System.out.println(returnString);
			JSONObject obj = new JSONObject(returnString);
		    str=obj.get("code").toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
		if(str.equals("0")){
	 ...
	 * @return
	 */
	public static boolean sendSmsVoice(String phone, String code) {
		String apikey = "190285e774686294dddc3de3286e812d";
		String str="";
		try {
	...
	public static String SMSnotify(String postData, String postUrl) {
		try {
			...
			postData = "action=send&userid=103&account=ABC&password=abc12345&sendTime=&extno=&mobile="
					+ postUrl
					+ "&content="
...
//		sendSmsProgram_old("13707173794,13098833176,18071756773","内部消息，7天收益翻番，还能抢IPhone 6s，点击查看详情http://t.cn/R4Qu44P");
...
//		sendSms("13707173794", str);
		System.out.println(getMd5("201605"));
	}
}
