...
public class ApiHttpClient {
	...
	public static SdkHttpResult getToken(String appKey, String appSecret,
		...
		HttpURLConnection conn = HttpUtil
				.CreatePostHttpConnection(appKey, appSecret, RONGCLOUDURI+ "/user/getToken." + format.toString());
	...
	public static SdkHttpResult checkOnline(String appKey, String appSecret,
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(appKey, appSecret, RONGCLOUDURI + "/user/checkOnline." + format.toString());
